...
process.env.NODE_ENV !== "production" ? Grid22.propTypes = {
  // ----------------------------- Warning --------------------------------
  // | These PropTypes are generated from the TypeScript type definitions |
...
var Snackbar = React70.forwardRef(function Snackbar2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded51), other = _objectWithoutPropertiesLoose(props, _excluded212);
  const ownerState = _extends({}, props, {
    anchorOrigin: {
      vertical,
      horizontal
...
var SpeedDial = React72.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    transitionDuration = defaultTransitionDuration,
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded53), other = _objectWithoutPropertiesLoose(props, _excluded213);
  ...
  const eventTimer = React72.useRef();
  React72.useEffect(() => {
    return () => {
...
var SwipeableDrawer = React88.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded64), other = _objectWithoutPropertiesLoose(props, _excluded214);
...
var import_dist231 = __toESM(require_dist());
...
var import_dist234 = __toESM(require_dist());
init_objectWithoutPropertiesLoose();
init_extends();
init_composeClasses();
init_clsx();
...
var import_dist233 = __toESM(require_dist());
init_utils();
init_generateUtilityClass();
