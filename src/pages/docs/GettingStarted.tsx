  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        before using Credit. The required Node.js version can be found in the{" "}
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        is installed, run <code>npm install</code> to install the rest of Credit's
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        <code>dist/</code> files. Credit is using Vite to automatically detect
